...
<html lang="en">
    <head>
        ...
        @if(Auth::user()->empresa=='001')

            <title>Criocord - Panel Administrativo</title>
        @elseif(Auth::user()->empresa=='002')
            <title>Lazo de Vida - Panel Administrativo</title>
        @endif
        ...
        @elseif(Auth::user()->empresa=='002')
            <link rel="shortcut icon" href="{{asset('imagenes/favicon_lazovida.ico')}}">
        @endif
        ...
        <link href="https://cdn.datatables.net/responsive/2.2.7/css/responsive.bootstrap4.min.css" rel="stylesheet" type="text/css" />
                ...
                <div class="logo-box">
                    <a href="index.html" class="logo text-center">
                        <span class="logo-lg">
                            ...
                            <img src="{{asset('imagenes/criocord_logo_white.png')}}" alt="" height="56">
                            @elseif(Auth::user()->empresa=='002')
                            <img src="{{asset('imagenes/lazo_de_vida_logo_white.png')}}" alt="" height="34">
                            @endif
            ...
            <div class="content-page">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
                                 2021 &copy; {{ config('app.name') }} - <a href="http://cayro.com.pe/" target="_blank" class="text-dark">Desarrollado por CAYRO SOLUCIONES</a> 
                            </div>
                            <div class="col-md-6">
